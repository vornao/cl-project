...
parser.add_argument('--savepath', type=str, default='../models/efficientnet_b0.pth', help='Path to save the model')
...
if __name__ == '__main__':
    ...
    print(f'Baseline loss: {baseline_loss:.4f}, Baseline accuracy: {baseline_acc*100:.2f}%')
    print(f'Training {args.model} model', 'with last layer only' if args.lastonly else '', ', epochs:', args.epochs)
